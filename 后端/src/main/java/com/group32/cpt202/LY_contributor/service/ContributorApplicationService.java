...
public class ContributorApplicationService {
    ...
    public void submitApplication(Long userId,
        ...
        newApp.setApplicantName(applicantName);
        newApp.setDomain(domain);
        newApp.setPortfolioUrl(portfolioUrl);
    ...
    public List<ContributorApplication> getPendingApplications() {
        return applicationRepository.findByStatusOrderByCreatedAtDescIdDesc(
